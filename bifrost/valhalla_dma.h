...
#define VALHALLA_ADDR_DMA_REG_BASE 0x00000110

#define VALHALLA_ADDR_DMA_STATUS (VALHALLA_ADDR_DMA_REG_BASE + 0x00)
#define VALHALLA_ADDR_DMA_ABORT  (VALHALLA_ADDR_DMA_REG_BASE + 0x04)
#define VALHALLA_ADDR_DMA_CHAN   (VALHALLA_ADDR_DMA_REG_BASE + 0x1C)
 ...
 */
#define VALHALLA_ADDR_DMA_SRC_ADDR    (VALHALLA_ADDR_DMA_REG_BASE + 0x08)
#define VALHALLA_ADDR_DMA_DEST_ADDR   (VALHALLA_ADDR_DMA_REG_BASE + 0x0C)
#define VALHALLA_ADDR_DMA_LEN_BYTES   (VALHALLA_ADDR_DMA_REG_BASE + 0x10)
#define VALHALLA_ADDR_DMA_DIR_UP_STRM (VALHALLA_ADDR_DMA_REG_BASE + 0x14)
#define VALHALLA_ADDR_DMA_START       (VALHALLA_ADDR_DMA_REG_BASE + 0x18)
