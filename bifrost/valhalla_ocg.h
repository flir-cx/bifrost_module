...
namespace VALHALLA_OCG
{
    ...
    /* CONTROL1 register */
    const uint32_t      CONTROL1_OFFSET             = 0x0F20;      ///< offset relative to unit base address
    ...
    /* CONTROL2 register */
    const uint32_t      CONTROL2_OFFSET             = 0x0F24;      ///< offset relative to unit base address
    ...
    /* CONTROL3 register */
    const uint32_t      CONTROL3_OFFSET             = 0x0F28;      ///< offset relative to unit base address
    ...
    /* CONTROL4 register */
    const uint32_t      CONTROL4_OFFSET             = 0x0F2C;      ///< offset relative to unit base address
    ...
    /* CONTROL5 register */
    const uint32_t      CONTROL5_OFFSET             = 0x0F30;      ///< offset relative to unit base address
    ...
    const uint32_t      CHAR_MAP_BASE               = 0x0000;
    ...
    const uint32_t      PIXEL_MAP_BASE              = 0x0400;
}
